...
def test_normalize_openai_endpoint_keeps_regional_cognitive_host() -> None:
    endpoint = "https://japaneast.api.cognitive.microsoft.com/"
    result = normalize_openai_endpoint(endpoint, account_name="aoai-test")
    assert result == "https://japaneast.api.cognitive.microsoft.com"
...
def test_validate_openai_config_accepts_regional_cognitive_host() -> None:
    result = validate_openai_config(
        api_key="key",
        endpoint="https://japaneast.api.cognitive.microsoft.com/",
        deployment="gpt-4o",
